...
| <<plugins-{type}s-{plugin}-start_date>> |<<string,string>>|Yes
...
Date to begin fetching reports at. The date should be in the format YYYY-MM-DD (example: "2020-04-05"). The input will fetch daily reports for all dates betwen `start_date` and `end_date`
